...
fM = readfis('2varM');        % загрузка нечёткой системы с диска
...
view(-40,30)
xlabel('x_1');   ylabel('x_2');   zlabel('y');
title('Система нечёткого вывода Мамдани (треуг.функ.прин.) - 2varM.fis')
...
fMg = readfis('2varMg');       % загрузка нечёткой системы с диска
...
axis([min(x1)  max(x1) ...
      min(x2)  max(x2) ...
      min(min(yMg))  max(max(yMg))]); 
view(-40,30)
xlabel('x_1');   ylabel('x_2');   zlabel('y');
title('Система нечёткого вывода Мамдани (гаус.функ.прин.) - 2varMg.fis')

%--------------------------------------------------------------------------
% Построение графика нечёткого отображения Сугено
%---------------------------------------------

fS = readfis('2varS');       % загрузка нечёткой системы с диска
...
view(-40,30)
xlabel('x_1');   ylabel('x_2');   zlabel('y');
title('Система нечёткого вывода Сугено - 2varS.fis')
